...
const orderItemCollection *mongo.Collection = database.OpenCollection(database.Client, "orderItem")
...
func GetOrderItem() gin.HandlerFunc {
   return func(c *gin.Context) {
      ...
      err := foodCollection.FindOne(ctx, bson.M{"Order_item_id": orderItemId}).Decode(&orderItem)
      if err != nil {
